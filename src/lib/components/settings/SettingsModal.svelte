<script lang="ts">
  ...
  let activeTab = $state<
    "typography" | "layout" | "header" | "headings" | "theme"
  >("typography");
...
{#if open}
  ...
  >
    ...
    <!-- svelte-ignore a11y_no_static_element_interactions -->
    <div
      class="max-h-[90vh] w-full max-w-2xl overflow-hidden rounded-lg bg-background shadow-xl"
          ...
          <div class="space-y-4">
            <div>
              ...
              <select
                ...
                onchange={(e) =>
                  settingsStore.update({ fontFamily: e.currentTarget.value })}
              >
                <optgroup label="Bundled Fonts">
                  <option value="Cairo">Cairo (Arabic)</option>
                </optgroup>
                <optgroup label="System Fonts - Arabic">
                  <option value="Helvetica Neue LT Arabic"
                    >Helvetica Neue LT Arabic</option
                  >
          ...
          <div class="space-y-4">
            <div>
              ...
              <select
                ...
                onchange={(e) =>
                  settingsStore.update({
                    pageSize: e.currentTarget.value as
                      | "A4"
                      | "Letter"
                      | "Legal",
                  })}
            ...
            <fieldset>
              <legend class="mb-2 text-sm font-medium"
                >{i18n.t.settings.margins}</legend
              >
          ...
          <div class="space-y-6">
            ...
            <fieldset class="space-y-4">
              ...
              <div class="flex items-center gap-2">
                ...
                />
                <label for="header-enabled" class="text-sm"
                  >{i18n.t.settings.enabled}</label
                >
              </div>
              ...
              {#if settingsStore.current.header.enabled}
                <div>
                  ...
                  {:else}
                    <label
                      for="logo-upload"
                      class="flex cursor-pointer items-center gap-2 rounded border border-dashed border-input px-4 py-3 hover:bg-accent"
                    >
                ...
                <div>
                  ...
                  <select
                    ...
                    onchange={(e) =>
                      settingsStore.updateHeader({
                        logoPosition: e.currentTarget.value as
                          | "left"
                          | "center"
                          | "right",
                      })}
                  >
                    <option value="left"
                      >{i18n.direction === "rtl" ? "Right" : "Left"}</option
                    >
                    <option value="center">Center</option>
                    <option value="right"
                      >{i18n.direction === "rtl" ? "Left" : "Right"}</option
                    >
                  </select>
                </div>
            ...
            <fieldset class="space-y-4">
              ...
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="rounded border-input"
                />
                <label for="footer-enabled" class="text-sm"
                  >{i18n.t.settings.enabled}</label
                >
              </div>
                  ...
                  <div>
                    ...
                    <div class="flex gap-2">
                      <input
                        ...
                        class="h-8 w-12 cursor-pointer rounded border border-input"
                      />
                      <Input
                        value={heading.color}
                        class="flex-1"
